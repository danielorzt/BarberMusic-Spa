...
public class AgendamientoController {
	...
	@PostMapping("/save")
	public String save(@RequestParam("servicio") Long idServicio,
			@RequestParam("sucursal") Long idSucursal,
		...
		try {
			...
			agendamiento
					.setFechaHora(LocalDateTime.parse(fechaHora, DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm")));
